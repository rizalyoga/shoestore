...
const footer = () => {
  return (
    <div className="w-full mt-10 bg-sky-100 bottom-0 left-0 right-0">
      <div className="container mx-auto px-5 lg:px-5 flex flex-wrap flex-col md:flex-row flex-wrap justify-between " style={{ maxWidth: "1200px" }}>
        {/* /* --------------------------- log & desc company ---------------------------  */}
        ...
        {/* /* -------------------------------- Category --------------------------------  */}
        <div className="category py-1 lg:py-5 md:w-4/12 lg:w-3/12">
        ...
        {/* /* ------------------------------ Informations ------------------------------  */}
        <div className="information py-3 lg:mt-16 md:w-4/12 lg:w-3/12">
        ...
        {/* /* ---------------------------- Social Media Icon ---------------------------  */}
        <div className="sosmed-icon py-3 lg:py-8 lg:w-2/12 text-navy flex text-2xl gap-3 justify-start lg:justify-end">
          <a href="#">
            <BsTwitter />
          </a>
          <a href="#">
